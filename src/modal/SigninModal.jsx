...
const signInWithGoogle = async () => {
  ...
  return (
    <>
      {signInModalOpen && (
        <motion.div className="rounded-lg bg-white w-[600px] overflow-hidden flex relative h-[400px]"
        ...
        transition={{duration: 0.8, type:"spring"}}>
          ...
          <img src={i2logo} alt="i2global" className="h-16"/>
            ...
            <p className="text-sm text-text font-medium pb-10">Let's get Started</p>
